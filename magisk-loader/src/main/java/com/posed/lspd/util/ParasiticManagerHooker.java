...
public class ParasiticManagerHooker {
                ...
                for (var i = 0; i < param.args.length; ++i) {
                    if (param.args[i] instanceof ActivityInfo) {
                        ...
                        for (var activity : pkgInfo.activities) {
                            if ("com.posed.manager.ui.activity.MainActivity".equals(activity.name)) {
                    ...
                    if (param.args[i] instanceof Intent) {
                        ...
                        intent.setComponent(new ComponentName(intent.getComponent().getPackageName(), "com.posed.manager.ui.activity.MainActivity"));
                    }
                }
    ...
    private static void checkIntent(ILSPManagerService managerService, Intent intent) {
        ...
        if (intent.getCategories() == null || !intent.getCategories().contains("com.posed.manager.LAUNCH_MANAGER")) {
